...
export const Hero = ({ initialData }: HeroProps) => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black font-sans selection:bg-green-100 dark:selection:bg-green-900/30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-10">
            <motion.div 
              ...
              className="space-y-4"
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-800 text-green-700 dark:text-green-400 text-xs font-bold uppercase tracking-widest leading-none">
                <Wind size={12} />
                Live Environmental Status
              </div>
              <h1 className="text-5xl lg:text-7xl font-black text-zinc-900 dark:text-zinc-50 tracking-tighter leading-[1.1]">
            ...
            <div className="grid grid-cols-2 gap-4 max-w-md">
              <div className="p-6 rounded-2xl bg-zinc-50 dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 transition-all hover:bg-zinc-100 dark:hover:bg-zinc-800/50">
                <div className="flex items-center gap-3 text-zinc-500 mb-2">
                  <Trees size={18} className="text-green-600" />
                  <span className="text-sm font-medium">Total Trees</span>
                </div>
                <div className="text-2xl font-bold text-zinc-900 dark:text-zinc-100 uppercase">
              ...
              <div className="flex flex-col gap-3">
                {Object.entries(ZONE_CONFIG).map(([key, config]) => (
                  <div key={key} className="flex items-start gap-4 group">
                    ...
                    />
                    <div>
                      <div className="text-sm font-bold text-zinc-800 dark:text-zinc-200">{config.label}</div>
          ...
          <motion.div 
            ...
            className="flex items-center justify-center p-4 lg:p-10 bg-zinc-50/50 dark:bg-zinc-900/20 rounded-[3rem] border border-zinc-100 dark:border-zinc-800 shadow-inner overflow-hidden min-h-[600px]"
          >
